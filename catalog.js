(() => {
  ...
  const projects = [
    ...
    },
    {
      ...
      genre: "Roguelite",
      platform: "Browser · Multiplayer",
      tech: ["Phaser 3", "Vite", "WebRTC", "Arcade Physics", "Procedural Rooms"],
      shortSummary: "A 4-player co-op browser roguelite with class-based combat, item stacking, and online play over WebRTC.",
      detailSummary:
        "Co-op Dungeon supports up to 4 players — any mix of local split-screen and online peers — descending through biome-based dungeon rooms. Four distinct classes (Knight, Ranger, Mage, Rogue) each have a primary attack and a unique ability. Items stack Risk of Rain-style to create emergent builds. Enemies have five behavior archetypes: direct chase, patrol-and-alert, charge rush, keep-distance ranged, and summoner. Built entirely in the browser with no backend beyond a lightweight WebRTC signaling relay.",
      controls: [
        "P1: WASD to move, SPACE to attack, Q for ability",
        "P2 (local): ARROWS to move, SHIFT to attack, P for ability",
        "Online: share room code, up to 3 machines × 2 local players",
        "Walk east through cleared rooms to advance",
      ],
      visualTheme: {
        accent: "#8855ff",
        accentAlt: "#ff5577",
        glow: "rgba(136, 85, 255, 0.26)",
        base: "#08060f",
      },
      featured: true,
      sortOrder: 1,
      year: 2026,
      q: "Q2",
      cover: "./covers/coop-dungeon.svg",
      repoUrl: "https://github.com/Sw0l1y/coop-dungeon",
      actions: [
        { label: "Play", href: "/games/coop-dungeon/", kind: "primary" },
        { label: "GitHub", href: "https://github.com/Sw0l1y/coop-dungeon", kind: "secondary" },
      ],
    },
    {
